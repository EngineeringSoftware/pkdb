...
class CommSerial(Comm):
    ...
    def exchange(self) -> None:
        with profiler.record("CommSerial::exchange_self"):
            pk.parallel_for(
    ...
    def exchange_halo(self) -> None:
        ...
        for self.phase in range(6):
            ...
            with profiler.record("CommSerial::halo_exchange_self"):
                pk.parallel_for(
    ...
    def update_halo(self) -> None:
        ...
        for self.phase in range(0, 6):
            ...
            with profiler.record("CommSerial::halo_update_self"):
                pk.parallel_for(
    ...
    def update_force(self) -> None:
        ...
        for self.phase in range(5, -1, -1):
            ...
            with profiler.record("CommSerial::halo_force_self"):
                pk.parallel_for(
