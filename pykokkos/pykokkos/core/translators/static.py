...
class StaticTranslator:
    ...
    def __init__(self, module: str, functor: str, functor_cast: str, pk_members: PyKokkosMembers, module_source_path: Optional[str] = None):
        """
        ...
        :param module_source_path: absolute path to the Python source file that
            defines the workunits in this module (used for line markers)
        """
        ...
        self.module_source_path: Optional[str] = (
            os.path.abspath(module_source_path) if module_source_path else None
        )
    ...
    def translate(
        ...
        bindings: List[str] = self.generate_bindings(entity, functor_name, source, workunits, space)
    ...
    def translate_functions(
        ...
        if self.module_source_path:
            env["__file__"] = self.module_source_path
    ...
    def generate_bindings(
        ...
        :param space: the execution space (for debug mode detection)
