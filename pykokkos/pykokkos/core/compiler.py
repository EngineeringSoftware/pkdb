...
class Compiler:
    ...
    def compile_entity(
        ...
        if module_setup.metadata and module_setup.metadata[0].path:
            module_source_path = module_setup.metadata[0].path
        ...
        functor, bindings, cast = translator.translate(entity, classtypes, restrict_views, space)
