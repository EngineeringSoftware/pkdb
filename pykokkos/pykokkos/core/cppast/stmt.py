...
class LineMarkerStmt(Stmt):
    """Represents a line number marker for Python-to-C++ line mapping."""

    def __init__(self, python_lineno: int, file_path: str):
        self._python_lineno: int = python_lineno
        self._file_path: str = file_path

    @property
    def python_lineno(self) -> int:
        return self._python_lineno
