...
class ModuleSetup:
    ...
    def get_output_dir(
        ...
        # Host-space kernels compiled while default space is GPU use different
        # pk_arg_memspace / pk_arg_layout; disambiguate cache directory names.
        # (Serial + default Cuda vs Serial + default OpenMP need separate JIT dirs)
        dir_name: str = space.name if space.name else space.value
